% Overview: Sets initial parameters - defining values, setting time step, and initializing vectors. 
...
Csa= 0.0022 %0.00175 ; %Systemic arterial compliance (liters/(mmHg))
%This value of Csa is approximate and will need adjustment to make the blood pressure be 120/80.
